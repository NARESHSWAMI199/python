...
class Smartphone(Phone):
    ...
    def full_detail(self):  # this fuction override the phone class method
        return f"{self.camera} {self.ram}"

class Smartphone2(Smartphone):
    def __init__(self, name,modal,price,camera,ram,rear,memory):
        super().__init__(name,modal,price,camera,ram)
        self.rear = rear
        self.memory = memory
...
print (isinstance(s,Smartphone2))  # this will retrun a boolean value
print( issubclass(Smartphone2,Smartphone))
